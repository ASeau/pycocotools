...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[4] = _summarize(1, areaRng='all', maxDets=self.params.maxDets[2])

            stats[5] = _summarize(1, areaRng='small', maxDets=self.params.maxDets[2])
            stats[6] = _summarize(1, areaRng='small16', maxDets=self.params.maxDets[2])
            stats[7] = _summarize(1, areaRng='small32', maxDets=self.params.maxDets[2])

            stats[8] = _summarize(1, areaRng='medium', maxDets=self.params.maxDets[2])
            stats[9] = _summarize(1, areaRng='medium48', maxDets=self.params.maxDets[2])
            stats[10] = _summarize(1, areaRng='medium64', maxDets=self.params.maxDets[2])
            stats[11] = _summarize(1, areaRng='medium80', maxDets=self.params.maxDets[2])
            stats[12] = _summarize(1, areaRng='medium96', maxDets=self.params.maxDets[2])

            stats[13] = _summarize(1, areaRng='large', maxDets=self.params.maxDets[2])
            stats[14] = _summarize(1, areaRng='large112', maxDets=self.params.maxDets[2])
            stats[15] = _summarize(1, areaRng='large128', maxDets=self.params.maxDets[2])
            stats[16] = _summarize(1, areaRng='large144', maxDets=self.params.maxDets[2])
            stats[17] = _summarize(1, areaRng='large160', maxDets=self.params.maxDets[2])
            '''
